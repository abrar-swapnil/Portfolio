...
function TimelineItem({ item, index, isLast }) {
  return (
    <div
      className="timeline-item relative flex gap-6 reveal"
    ...
    >
      ...
      <div className="pb-10 flex-1 min-w-0">
        <div className="flex flex-wrap items-start justify-between gap-2 mb-2">
          <div>
            <h3
              className="timeline-title font-semibold text-base"
    ...
    >
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid md:grid-cols-[1fr_1.8fr] gap-16 items-start">
          ...
          {/* Left */}
          <div className="md:sticky md:top-24 reveal" style={{ '--delay': '0ms' }}>
            <p className="section-label">Experience & Focus</p>
            <h2 id="experience-title" className="section-heading">
              <span className="rewrite-text" data-rewrite>Current </span>
